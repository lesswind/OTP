...
* Any game cart that contains an update version between 4.0 and (possibly 6.1? further testing needed to confirm exact version limit) (See [3dsdb](http://www.3dsdb.com/) for which carts contain what updates)
